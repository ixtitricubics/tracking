...
def _cosine_distance(a, b, data_is_normalized=False):
    ...
    # print('inside cosine distance',a.shape, b.T.shap e,  np.dot(a, b.T).shape)
...
def cord_euclidian_dist(mean, bbox):
    x,y = bbox[:2]
    x_,y_ = mean[:2]
...
class NearestNeighborDistanceMetric(object):
    ...
    def distance(self, tracks, dets, width=None, height=None):
        ...
        # for i, target_mean in enumerate(means):
        #     for j, bbox in enumerate(bboxes):
        #         cost_matrix[i,j] +=  0.0 * cord_euclidian_dist(target_mean, bbox) / np.sqrt((width * height))
        # print("cost matrix")               
        # print(cost_matrix)
        return cost_matrix
